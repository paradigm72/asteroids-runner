...
EntityAsteroid = ig.Entity.extend({
	...
	animSheet: new ig.AnimationSheet( 'media/asteroid/asteroid.png',48,48),
	...
	check: function(entityHit) {
		if ((entityHit instanceof EntityLaserShot) ||
            (entityHit instanceof EntityShip)) {
            this.killMe();
            entityHit.killMe();
    ...
    killMe: function() {
        ...
        //add to the shield meter
        ig.game.shieldMeter.addStrength();
