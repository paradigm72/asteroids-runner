...
EntityTutorial = ig.Entity.extend({
    ...
    animSheet: new ig.AnimationSheet( 'media/tutorial/tutorial.png', 300, 48 ),
    ...
    init: function( x, y, settings ) {
        ...
        //position this just above the shield meter
        this.pos.y = ig.game.consts.screenHeight - this.size.y -
                     ig.game.shieldMeterImg.height - 10;


        this.tutorialFont = new ig.Font('media/tutorial/tutorialFont.png');
