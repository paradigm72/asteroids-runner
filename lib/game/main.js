...
MainGame = ig.Game.extend({
	...
	draw: function() {
        ...
        if (this.gameState === this.gameStateEnum.playerDead_ready) {
            ...
            this.replayButton.draw(this.LogicalToPixelX(20) - this.replayButton.width / 2, replayButtonY);
            this.font.draw("RETRY", this.LogicalToPixelX(20), replayButtonY, ig.Font.ALIGN.CENTER);

            var mainMenuButtonY = this.LogicalToPixelY(80);
            this.mainMenuButton.draw(this.LogicalToPixelX(80) - this.mainMenuButton.width / 2, mainMenuButtonY);
            this.font.draw("MENU", this.LogicalToPixelX(80), mainMenuButtonY, ig.Font.ALIGN.CENTER);
        }
	},
