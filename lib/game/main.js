...
MainGame = ig.Game.extend({
    ...
    init: function() {
        ...
        this.shieldMeter.enableShieldCallback = this.raise_enableShieldCallback;
    ...
    raise_enableShieldCallback: function() {
        //Hardcoding a single ship here. Figure out how to match someday.
        var playerShip = ig.game.getEntitiesByType(EntityShip)[0];

        shipPos = playerShip.pos;
        ig.game.spawnEntity(EntityShield, playerShip.pos.x, playerShip.pos.y,
