...
MainGame = ig.Game.extend({
	...
	draw: function() {
        ...
        if (this.gameState === this.gameStateEnum.playerDead_ready) {
            var replayButtonY = this.LogicalToPixelY(50)
            this.replayButton.draw(this.LogicalToPixelX(50) - this.replayButton.width / 2, replayButtonY);
            this.font.draw("RETRY", this.LogicalToPixelX(50), replayButtonY, ig.Font.ALIGN.CENTER);

            var mainMenuButtonY = this.LogicalToPixelY(80);
            this.mainMenuButton.draw(this.LogicalToPixelX(50) - this.mainMenuButton.width / 2, mainMenuButtonY);
            this.font.draw("MENU", this.LogicalToPixelX(50), mainMenuButtonY, ig.Font.ALIGN.CENTER);
        }
	},
    ...
    initInputBindings: function () {
        ...
        if (ig.ua.mobile) {
            var replayButtonDims = {
                x: this.LogicalToPixelX(50) - this.replayButton.width / 2,
                y: this.LogicalToPixelY(50),
            ...
            var mainMenuButtonDims = {
                x: this.LogicalToPixelX (50) - this.mainMenuButton.width / 2,
