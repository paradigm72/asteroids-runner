...
var SCREEN_HEIGHT = null;  //no longer really a const - adjusts to fill device size
...
MainGame = ig.Game.extend({
    ...
    //shield assets
    shieldMeterImg: new ig.Image('media/shieldMeter.png'),
    shieldBlackImg: new ig.Image('media/shieldBlack.png'),
	...
	draw: function() {
        ...
        // If the shield is activated, draw a message for now
        if (this.shieldMeter.isShieldPulsing) {
            this.font.draw ("Shield Up!", this.LogicalToPixelX(50), this.LogicalToPixelY(70), ig.Font.ALIGN.CENTER);
        }
		...
		if (this.gameState === this.gameStateEnum.playerDead_ready) {
            ...
            this.font.draw("Asteroids destroyed: " + this.gameStats.asteroidsDestroyed,
                           this.LogicalToPixelX(50), this.LogicalToPixelY(35), ig.Font.ALIGN.CENTER);
            this.font.draw("Shots fired: " + this.gameStats.shotsFired,
                           this.LogicalToPixelX(50), this.LogicalToPixelY(45), ig.Font.ALIGN.CENTER);
            this.font.draw("Time survived: " + Math.round(this.gameSpeedTimer.delta()*100)/100 + "s",
                           this.LogicalToPixelX(50), this.LogicalToPixelY(55), ig.Font.ALIGN.CENTER);
            this.font.draw("Total score: " + this.score,
                           this.LogicalToPixelX(50), this.LogicalToPixelY(65), ig.Font.ALIGN.CENTER);
            ...
            this.font.draw("RETRY", this.LogicalToPixelX(25), replayButtonY, ig.Font.ALIGN.CENTER);
            ...
            this.font.draw("MENU", this.LogicalToPixelX(75), mainMenuButtonY, ig.Font.ALIGN.CENTER);
        }
	},
...
TitleScreen = ig.Game.extend({
    ...
    draw: function() {
        ...
        this.font.draw("Asteroid Runner", this.LogicalToPixelX(50),
        ...
        this.startButton.draw(this.LogicalToPixelX(50) - this.startButton.width / 2,
                              buttonY);
        this.font.draw("PLAY!", this.LogicalToPixelX(50), buttonY,
                       ig.Font.ALIGN.CENTER);
    },
...
// Start the Game
ig.main('#canvas', TitleScreen, 60, SCREEN_WIDTH, window.innerHeight, 1);
